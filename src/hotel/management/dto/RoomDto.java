...
public class RoomDto { 
    ...
    public RoomDto(String roomId, String floor, double floorArea, boolean bed, boolean table, boolean coffeeKit, String bedType, boolean ac, boolean NonAc, String roomCatogory) {
        this.roomId = roomId;
        this.floor = floor;
    ...
    public String toString() {
        return "RoomDto{" + "roomId=" + roomId + ", floor=" + floor + ", floorArea=" + floorArea + ", bed=" + bed + ", table=" + table + ", coffeeKit=" + coffeeKit + ", bedType=" + bedType + ", ac=" + ac + ", NonAc=" + NonAc + ", roomCatogory=" + roomCatogory + '}';
    }
}
