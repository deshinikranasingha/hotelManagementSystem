...
public class RoomCatogoryDto {
    ...
    public RoomCatogoryDto() {
    }

    public RoomCatogoryDto(String roomCatogoryId, String roomCatogoryName, double fullBoardPrice, double halfBoardPrice, double breadAndBreakfastPrice) {
    ...
    public String toString() {
        return "RoomCatogoryDto{" + "roomCatogoryId=" + roomCatogoryId + ", roomCatogoryName=" + roomCatogoryName + ", fullBoardPrice=" + fullBoardPrice + ", halfBoardPrice=" + halfBoardPrice + ", breadAndBreakfastPrice=" + breadAndBreakfastPrice + '}';
    }
